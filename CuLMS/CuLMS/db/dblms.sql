...
(1, 'banner_title', 'PEER 2 PEER Learning Portal'),
(2, 'banner_sub_title', 'The platform will offer peer-to-peer learning management system (P2P LMS)& and Google authentication for users to access &the platform securely.'),
...
(4, 'system_email', 'admin@culearn.com'),
...
(1, 'admin', 'admin', 'admin@culearn.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', '{\"facebook\":\"\",\"twitter\":\"\",\"linkedin\":\"\"}', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
