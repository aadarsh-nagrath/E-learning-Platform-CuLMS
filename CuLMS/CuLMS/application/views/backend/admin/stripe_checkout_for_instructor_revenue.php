...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url('assets/payment/css/stripe.css');?>"
            rel="stylesheet">
        <link name="favicon" type="image/x-icon" href="<?php echo base_url();?>uploads/system/favicons.png" rel="shortcut icon" />
    </head>
    <body>
...
<!--required for getting the stripe token-->
        ...
        <img src="<?php echo base_url().'uploads/system/culmsw.png'; ?>" width="15%;"
             style="opacity: 0.05;">
            <form method="post"
