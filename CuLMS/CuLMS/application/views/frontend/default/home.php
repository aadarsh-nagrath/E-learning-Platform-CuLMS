        ...
        <div class="row">
            <div class="col">
                <div class="home-banner-wrap">
                    <h2><?php echo get_phrase('PEER_TO_PEER_Learning_Portal ~ P_2_P'); ?></h2>
                    <p><?php echo get_phrase('The platform offers peer-to-peer Learning Management System designed to learn and teach eachother'); ?></p>
        ...
        <div class="row">
            ...
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    ...
                    <div class="text-box">
                        ...
                        echo $number_of_courses.' '.get_phrase('active_courses'); ?></h4>
                        <p><?php echo get_phrase('explore_various_educational_courses'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    ...
                    <div class="text-box">
                        <h4><?php echo get_phrase('peer_interactivity'); ?></h4>
                        <p><?php echo get_phrase('learn_from_your_peers'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    ...
                    <div class="text-box">
                        ...
                        <p><?php echo get_phrase('learn_at_your_own_pace'); ?></p>
                    </div>
                </div>
            </div>
        </div>
